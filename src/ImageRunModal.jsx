            ...
            <Form>
                ...
                <Tabs activeKey={activeTabKey} onSelect={this.handleTabClick}>
                    <Tab eventKey={0} title={<TabTitleText>{_("Details")}</TabTitleText>} className="pf-c-form pf-m-horizontal">
                        ...
                        <FormGroup className='run-image-dialog-owner' isInline hasNoPaddingTop fieldId='run-image-dialog-owner' label={_("Owner")}
                                   labelIcon={
                                       <Popover className='owner-popover' aria-label={_("Owner help")} style={{ minWidth: 0 }}
                                          enableFlip
                                          bodyContent={
                                              <>
                                                  <TextContent>
