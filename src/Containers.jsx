...
class Containers extends React.Component {
    ...
    render() {
        ...
        let filtered = [];
        Object.keys(this.props.containers).filter(id => { if (!this.props.onlyShowRunning || this.props.containers[id].State.Running) { filtered.push(this.props.containers[id]) } });
        let rows = filtered.map((ctr, id) => this.renderRow(containersStats, ctr));
