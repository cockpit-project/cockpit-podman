...
VM_CUSTOMIZE_FLAGS += --run-command 'dnf -y copr enable rhcontainerbot/podman-next >&2; dnf copr enable packit/containers-podman-25538 >&2; dnf -y update --repo "copr*" >&2'
else
