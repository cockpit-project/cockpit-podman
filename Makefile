...
check: prepare-check
	TEST_AUDIT_NO_SELINUX=1 test/common/run-tests -vt TestApplication.testCreateContainerValidation TestApplication.testCreateContainerValidation2 TestApplication.testCreateContainerValidation3 TestApplication.testCreateContainerValidation4 ${RUN_TESTS_OPTIONS}
